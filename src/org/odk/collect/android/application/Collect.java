...
public class Collect extends Application {
    ...
    // This causes problems, getting preferences from a buried call
    // Should this ask for a content resolver?  Or a prefs class that has a singleton that is not the application?
